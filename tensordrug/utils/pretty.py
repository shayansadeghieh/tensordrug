# NOTE: THESE CLASSES HAVE BEEN COPIED FROM THE TORCHDRUG IMPLEMENTATION
# See: https://github.com/DeepGraphLearning/torchdrug/blob/master/torchdrug/utils/pretty.py
separator = ">" * 30
line = "-" * 30
