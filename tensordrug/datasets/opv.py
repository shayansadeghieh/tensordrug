...
class OPV(data.MoleculeDataset):
    ...
    def __init__(self, path, verbose=1, **kwargs):
        ...
        targets = {
            k: train_targets[k] + valid_targets[k] + test_targets[k]
    ...
    def split(self):
        ...
        valid_set = torch_data.Subset(
            self, range(self.num_train, self.num_train + self.num_valid)
        )
